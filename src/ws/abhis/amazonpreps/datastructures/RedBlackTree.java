...
1) For a general Binary Tree, let k be the minimum number of nodes on all root to NULL paths, then n >= 2k – 1 (Ex. If k is 3, then n is atleast 7). This expression can also be written as k <=2\log_2(n+1)
...
From above 2 points, we can conclude the fact that Red Black Tree with n nodes has height <= 2\log_2(n+1)
